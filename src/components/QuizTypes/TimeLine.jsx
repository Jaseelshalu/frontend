...
const TimeLine = ({data,setIndex}) => {
  return (
    <div className="w-[100%] lg:max-w-[70%] m-auto p-10 overflow-auto bg-color1 ">
         
<ol class="items-center flex">
    {data.body.map((item)=>(
        <li class="relative min-w-[300px] mb-6 sm:mb-0">
        ...
        <div class="mt-3 sm:pe-8">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{item.head}</h3>
